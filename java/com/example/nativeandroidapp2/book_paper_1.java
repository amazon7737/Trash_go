...
public class book_paper_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_book_paper1);
        setTitle("분리수거 백과사전[종이]");
        ...
        Button paperPage_1 = findViewById(R.id.paperNextPage);
        paperPage_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), book_paper_2.class);
                startActivity(intent);
            }
        });
