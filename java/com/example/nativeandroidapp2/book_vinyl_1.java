...
public class book_vinyl_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_book_vinyl1);
        setTitle("분리수거 백과사전[비닐]");
        ...
        Button vinylPage_1 = findViewById(R.id.paperNextPage);
        vinylPage_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), book_vinyl_2.class);
                startActivity(intent);
            }
        });
